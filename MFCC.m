function [c,f,tc]=MFCC(s,fs,w,nc,p,n,inc,fl,fh,alpha)
...
%preemphasis from mfcc program
 s = filter( [1 -alpha], 1, s);

f0=80;
fNominal = 40;eta=1;
tt=linspace(-0.0125,0.0125,200);
tNominal=linspace(-0.025,0.025,400);
...
wxe = interp1q(tNominal',wPSGSeed',tt'*f0/fNominal)';
%wxe = interp1q(tNominal',wPSGSeed',tt'*pitch_m/fNominal)';
